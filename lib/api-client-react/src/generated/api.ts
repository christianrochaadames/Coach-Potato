 ...
 */
export const tmdbSearch = async (params: TmdbSearchParams, options?: Parameters<typeof customFetch>[1]): Promise<TmdbSearchResponse> => {

  return customFetch<TmdbSearchResponse>(getTmdbSearchUrl(params),
  {
    ...options,
    method: 'GET'
...
export const getTmdbSearchQueryOptions = <TData = Awaited<ReturnType<typeof tmdbSearch>>, TError = ErrorType<ErrorResponse>>(params: TmdbSearchParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof tmdbSearch>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
export type TmdbSearchQueryError = ErrorType<ErrorResponse>
...
export function useTmdbSearch<TData = Awaited<ReturnType<typeof tmdbSearch>>, TError = ErrorType<ErrorResponse>>(
...
export const getTmdbTrendingUrl = () => {




  return `/api/tmdb/trending`
}

/**
 * @summary Get trending movies and shows from TMDB
 */
export const tmdbTrending = async ( options?: Parameters<typeof customFetch>[1]): Promise<TmdbSearchResponse> => {

  return customFetch<TmdbSearchResponse>(getTmdbTrendingUrl(),
  {
    ...options,
    method: 'GET'
...
export const getTmdbTrendingQueryKey = () => {
    return [
    `/api/tmdb/trending`
    ] as const;
    }
...
export const getTmdbTrendingQueryOptions = <TData = Awaited<ReturnType<typeof tmdbTrending>>, TError = ErrorType<ErrorResponse>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof tmdbTrending>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getTmdbTrendingQueryKey();



    const queryFn: QueryFunction<Awaited<ReturnType<typeof tmdbTrending>>> = ({ signal }) => tmdbTrending({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof tmdbTrending>>, TError, TData> & { queryKey: QueryKey }
}

export type TmdbTrendingQueryResult = NonNullable<Awaited<ReturnType<typeof tmdbTrending>>>
export type TmdbTrendingQueryError = ErrorType<ErrorResponse>
...
export function useTmdbTrending<TData = Awaited<ReturnType<typeof tmdbTrending>>, TError = ErrorType<ErrorResponse>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof tmdbTrending>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getTmdbTrendingQueryOptions(options)
...
export const getTmdbPopularUrl = () => {




  return `/api/tmdb/popular`
}

/**
 * @summary Get popular movies and shows from TMDB
 */
export const tmdbPopular = async ( options?: Parameters<typeof customFetch>[1]): Promise<TmdbPopularResponse> => {

  return customFetch<TmdbPopularResponse>(getTmdbPopularUrl(),
  {
    ...options,
    method: 'GET'
...
export const getTmdbPopularQueryKey = () => {
    return [
    `/api/tmdb/popular`
    ] as const;
    }
...
export const getTmdbPopularQueryOptions = <TData = Awaited<ReturnType<typeof tmdbPopular>>, TError = ErrorType<ErrorResponse>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof tmdbPopular>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getTmdbPopularQueryKey();



    const queryFn: QueryFunction<Awaited<ReturnType<typeof tmdbPopular>>> = ({ signal }) => tmdbPopular({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof tmdbPopular>>, TError, TData> & { queryKey: QueryKey }
}

export type TmdbPopularQueryResult = NonNullable<Awaited<ReturnType<typeof tmdbPopular>>>
export type TmdbPopularQueryError = ErrorType<ErrorResponse>
...
export function useTmdbPopular<TData = Awaited<ReturnType<typeof tmdbPopular>>, TError = ErrorType<ErrorResponse>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof tmdbPopular>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getTmdbPopularQueryOptions(options)
